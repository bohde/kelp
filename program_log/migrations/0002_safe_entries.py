...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('program_log_entry', 'date', orm['program_log.entry:date'])
        
        # Creating unique_together for [slot, date] on Entry.
        db.create_unique('program_log_entry', ['slot_id', 'date'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [slot, date] on Entry.
        db.delete_unique('program_log_entry', ['slot_id', 'date'])
